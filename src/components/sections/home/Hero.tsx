...
const DEFAULT_HERO = {
  ...
  title: 'Build next-gen applications with',
  titleHighlight: 'intelligent automation',
  description:
    'Transform your development workflow with AI-enhanced tools. Deploy faster, scale smarter, and deliver exceptional user experiences with our cutting-edge platform.',
  features: [
  ...
  statsLabel2: 'Developers',
  statsValue2: '50K+ Active',
} as const;
